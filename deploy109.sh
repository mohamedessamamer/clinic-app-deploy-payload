...
ARCHIVE="clinic-app-batch109.tar.gz"
ARCHIVE_SHA256="8DBD3F42A18194F1C1D22ACC65F102CB4AF359BE17EA7121D1E2AF2DF442267C"
...
BACKUP_DIR="/opt/clinic-app-data.backup-batch109-$STAMP"
PREVIOUS_DIR="/opt/clinic-app.previous-batch109-$STAMP"
FAILED_DIR="/opt/clinic-app.failed-batch109-$STAMP"
TEMP_DIR="$(mktemp -d /tmp/clinic-app-batch109-deploy.XXXXXX)"
...
cleanup() {
  ...
  if [[ -d "$TEMP_DIR" && "$TEMP_DIR" == /tmp/clinic-app-batch109-deploy.* ]]; then
    rm -rf -- "$TEMP_DIR"
  fi
