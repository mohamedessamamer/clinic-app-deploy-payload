...
ARCHIVE="clinic-app-batch133.tar.gz"
ARCHIVE_SHA256="F2CBE37C190B51F59F282BB16E8F8A0B3380704E7B0F63FFF783A6F760D92963"
...
BACKUP_DIR="/opt/clinic-app-data.backup-batch133-$STAMP"
PREVIOUS_DIR="/opt/clinic-app.previous-batch133-$STAMP"
FAILED_DIR="/opt/clinic-app.failed-batch133-$STAMP"
TEMP_DIR="$(mktemp -d /tmp/clinic-app-batch133-deploy.XXXXXX)"
...
# Batch 133 upgrades the published Batch 132 (== the deploy that split salary
# from commission, added shift weekdays, and fixed the payroll sheet totals).
# Refuse to overwrite unreviewed server-side changes before stopping the app.
#
# Hashes computed directly from the published clinic-app-batch132.tar.gz. The
# list is deliberately narrow: the files batch132 shipped plus the one file
# batch133 touches. A mismatch here means someone edited the live server.
echo "== checking live batch-132 source before replacement =="
while read -r expected relative; do
  ...
  if [[ "$actual" != "$expected" ]]; then
    fail "Live source differs from published batch 132: $relative. Merge the server-side change before deploying batch 133."
  fi
done <<'BATCH132_BASELINE_HASHES'
...
e9d98a0f2fd482f52ee20713b32bbe8f9d48e8207ac6830b889df4cd8989259a src/lib/hr-payroll-math.ts
749bab527415032f93de3187cbf912e6d9cbe4c45174ab9e9db08cc2f9f167e3 src/lib/weekdays.ts
37019e471d55a6a58b5f38e6cb3367485bebdc44db230250d9d0459f7380bdd9 src/lib/settings.ts
...
46eea3f7493fd4021a37791936b2af73be4bde1c57c333617be80da7e0fe6a5a src/components/HrWorkspace.tsx
495e3243e8808b3b86a6a17753afc568c9d362985cb65282f1e454ad2a36bf1a src/components/HrPayrollTable.tsx
29704dd277b85b26f5caa8114d413f8b777a63f20ad487d253103bd4493ec0c2 src/components/CentralSchedule.tsx
f0828b20ca56d748c60a7af7c96068d50a736f871406f6f058592c8abac1c5ce src/app/expenses/page.tsx
4f02f9f83bbc8934a733fff7c73c72d57bb3643a782b957c95c572dda1721ba1 src/app/expenses/actions.ts
a3ee5a5f31239072d664867e2588bb1737d8020ebcdd6f17ab0abe46c8650dcb src/app/hr/actions.ts
d4fad49d4e631d3c9c7ac7b38475d785692f4607475813cfc0ee5edda359e65e src/app/globals.css
16171dccc451c530b87d091be2789a5c53f2c28b7f125a00b835c6aa51894dd9 scripts/import-legacy-visits.mjs
BATCH132_BASELINE_HASHES
...
require_file "$STAGE_DIR/docs/BATCH133.md"
require_file "$STAGE_DIR/src/components/HrPayrollTable.tsx"
require_file "$STAGE_DIR/src/lib/hr-payroll.ts"
require_file "$STAGE_DIR/src/lib/hr-payroll-math.ts"
