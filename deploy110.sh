...
ARCHIVE="clinic-app-batch110.tar.gz"
ARCHIVE_SHA256="BA1B364A9182C6D4394024AE75FB760BA6DA96F66D58F530816234492546A418"
...
BACKUP_DIR="/opt/clinic-app-data.backup-batch110-$STAMP"
PREVIOUS_DIR="/opt/clinic-app.previous-batch110-$STAMP"
FAILED_DIR="/opt/clinic-app.failed-batch110-$STAMP"
TEMP_DIR="$(mktemp -d /tmp/clinic-app-batch110-deploy.XXXXXX)"
...
cleanup() {
  ...
  if [[ -d "$TEMP_DIR" && "$TEMP_DIR" == /tmp/clinic-app-batch110-deploy.* ]]; then
    rm -rf -- "$TEMP_DIR"
  fi
...
# Batch 110 replaces the full source tree. Refuse to overwrite any server-side
# hotfix made after batch 109 in the files this batch changes.
echo "== checking live batch-109 source before replacement =="
while read -r expected relative; do
  ...
  if [[ "$actual" != "$expected" ]]; then
    fail "Live source differs from batch 109: $relative. Merge the server-side change before deploying batch 110."
  fi
done <<'BATCH110_BASELINE_HASHES'
a6649eb701b5c729f20f762cd412e21ae9f7bbe75c804191b11bea800dede4da src/app/front-desk/page.tsx
5deeaa29949f62215cba896726e8d533e7a66977a774e92abbc78ab1134e867d src/app/globals.css
5c6551bdc7bec447a7e149503f05725bd280a3277883dbcda6c2a66bc92774c4 src/app/layout.tsx
ef0157cca59ccf89a7d31155bc8c67ea35c97096fbdb4f8b83a390389229f678 src/app/page.tsx
d51149827ea2df88abac5b547890cc603e31b6aeda7db8d9e51c99f18341b68f src/app/patients/[id]/billing/actions.ts
c17e04398c30571475bb1710ce400aa42dc218adc02cc23c852a153f15b8a4b3 src/app/patients/[id]/billing/page.tsx
b397b69e696c6afb8ecec7d615eb7950c6888ef7d55b9890407a02c0d8ce470d src/app/patients/[id]/page.tsx
af2cf24083d15eebdfc80990834e98db90c2ddec8c2105ee23ad430b7d369215 src/components/CentralSchedule.tsx
fd4a4a9a7167fb6b67cd37de806c5380d3cb73c7b757080792087c6ad1b72690 src/components/EditInvoiceButton.tsx
c409540da11495fa41ccbaa4610de2f9ac7dead5d16c5ec4f818194ca333a189 src/components/NavBar.tsx
1ccfaa6e7799257a49b754c10871a60bbeaf5d4f835f68f668ec9dff787d8e33 src/components/QuickPatientSearch.tsx
a1c3a24b12fb945a4b7771f4c1f857aa3577b8030c9f4fda21e60f0256a32246 src/components/VisitsTable.tsx
BATCH110_BASELINE_HASHES
[[ ! -e "$APP_DIR/src/components/MedicalVisitHistory.tsx" ]] \
  || fail "Live source already contains MedicalVisitHistory.tsx; merge it before deploying batch 110."
