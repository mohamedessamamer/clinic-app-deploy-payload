...
ARCHIVE="clinic-app-batch115.tar.gz"
ARCHIVE_SHA256="C9E1215BA94C4FB6C2AB9DA64542EB750E821384877E4B1921F71A9E64F8FD02"
...
BACKUP_DIR="/opt/clinic-app-data.backup-batch115-$STAMP"
PREVIOUS_DIR="/opt/clinic-app.previous-batch115-$STAMP"
FAILED_DIR="/opt/clinic-app.failed-batch115-$STAMP"
TEMP_DIR="$(mktemp -d /tmp/clinic-app-batch115-deploy.XXXXXX)"
...
cleanup() {
  ...
  if [[ -d "$TEMP_DIR" && "$TEMP_DIR" == /tmp/clinic-app-batch115-deploy.* ]]; then
    rm -rf -- "$TEMP_DIR"
  fi
